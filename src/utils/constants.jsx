...
//Popular games
const popular_games = `games?key=${apiKey}&dates=${lastYear},${currentDate}&ordering=-rating&page_size=40`;

//Upcoming games
const upcoming_games = `games?key=${apiKey}&dates=${currentDate},${nextYear}&ordering=-added&page_size=40`;

//Recently released
const new_games = `games?key=${apiKey}&dates=${lastYear},${currentDate}&ordering=-released&page_size=40`;
...
export const searchGameGet = game_name => `${ base_url }${ query_games }${ game_name }&page_size=1`;
...
export const sampleGenreGamesGet = genre_id => `${ base_url }${ genre_games }${ genre_id }&page_size=41`;
...
export const samplePlatformGamesGet = platform_id => `${ base_url }${ platform_games }${platform_id}&page_size=41`;
